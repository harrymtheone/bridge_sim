...
from isaaclab.markers import VisualizationMarkersCfg, RAY_CASTER_MARKER_CFG
from isaaclab.sensors import SensorBaseCfg
from isaaclab.sensors.ray_caster.patterns import PatternBaseCfg
from isaaclab.utils import configclass

from . import RayCasterV2


@configclass
class RayCasterV2Cfg(SensorBaseCfg):
    """Configuration for the ray-cast sensor."""
    ...
    ray_alignment: Literal["base", "yaw", "world", "base_v"] = "base"
